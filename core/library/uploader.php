...
class Uploader
{
    ...
    private $nameStyle = 1;           //设置上传的文件的命名方式，0代表保留原文件名，1代表生成随机文件名，2代表手动指定文件名
    private $appointName = '';
    ...
    public function getFilePath()
    {
        if (is_array($this->newFileName)) {
            ...
            array_map(array($this, 'addPath'), $newFilePath);
        } else {
            $newFilePath = $this->addPath($this->newFileName);
        }
        return $newFilePath;
    }
     ...
     * @return string
     */
    private function addPath($fileName)
    {
    ...
    private function setNewFileName()
    {
        switch ($this->nameStyle) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setOption('newFileName', $this->appointName);
                break;
        }
    }
